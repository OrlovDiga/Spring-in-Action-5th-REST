...
public class RestExamples {
    ...
    @Bean
    public CommandLineRunner fetchIngredients(TacoCloudRestClient tacoCloudClient) {
        return args -> {
            log.info("----------------------- GET -------------------------");
    ...
    @Bean
    public CommandLineRunner putAnIngredient(TacoCloudRestClient tacoCloudClient) {
        return args -> {
            log.info("----------------------- PUT -------------------------");
    ...
    @Bean
    public CommandLineRunner addAnIngredient(TacoCloudRestClient tacoCloudClient) {
        return args -> {
            log.info("----------------------- POST -------------------------");
...
//      log.info("AFTER-3:  " + shrimpAfter);
    ...
    @Bean
    public CommandLineRunner deleteAnIngredient(TacoCloudRestClient tacoCloudClient) {
        return args -> {
            log.info("----------------------- DELETE -------------------------");
    ...
    @Bean
    public CommandLineRunner traversonGetIngredients(TacoCloudRestClient tacoCloudClient) {
        return args -> {
    ...
    @Bean
    public CommandLineRunner traversonSaveIngredient(TacoCloudRestClient tacoCloudClient) {
        return args -> {
    ...
    @Bean
    public CommandLineRunner traversonRecentTacos(TacoCloudRestClient tacoCloudClient) {
        return args -> {
            Iterable<Taco> recentTacos = tacoCloudClient.getRecentTacos();
