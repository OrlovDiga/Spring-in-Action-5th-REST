...
public class DevelopmentConfig {
    ...
    @Bean
    public CommandLineRunner dataLoader(IngredientRepo ingredientRepo, UserRepo userRepo, PasswordEncoder encoder,
                                        TacoRepo tacoRepo) {
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                userRepo.save(new User("diga", encoder.encode("diga"),
                        "Orlov Diga", "123 North Street", "Cross Roads", "TX",
                        "76227", "123-123-1234"));
